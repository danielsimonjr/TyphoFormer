...
- [ ] **Re-tune on the full dataset.** The recipe's hyperparameters were tuned on 98 storms; best epochs on 826 storms land early (2–27 of 30), suggesting a scaled pass over lr/lr_decay/dropout/epochs (and possibly `--huber` δ, since the residual scale changed with the coordinate stats) is worth a battery. Also investigate the seed-3 6h outlier (40.0 vs 31.6–35.5).
