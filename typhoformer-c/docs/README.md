...
| [EXTENDING.md](EXTENDING.md) | both | How to **add a new layer or op** with the gradient-check discipline, change the config, and a roadmap of good student projects. |
